              ...
              content={
                <>
                  <p>
                    ...
                    website. These requests originate from a specific server,
                    and this server has a real world location. San Fransisco to
                    be precise. So any website that is stored on a server close
                    to San Fransisco will see its speed score go up, whereas
                    websites stored on servers further away will experience
                    lower scores.
                  </p>
                  <p>
                    {" "}
